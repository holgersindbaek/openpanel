...
### CLICKHOUSE_QUERY_REQUEST_TIMEOUT_MS

**Type**: `number`
**Required**: No
**Default**: `300000`

ClickHouse HTTP timeout for analytics read queries, in milliseconds. Increase this for high-volume self-hosted installs where large reports need more time to finish.

**Example**:
```bash
CLICKHOUSE_QUERY_REQUEST_TIMEOUT_MS=300000
```
